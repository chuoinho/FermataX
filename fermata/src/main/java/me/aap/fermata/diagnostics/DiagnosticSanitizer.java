...
public final class DiagnosticSanitizer {
	...
	private static final Set<String> EVENT_ATTRIBUTE_KEYS = Collections.unmodifiableSet(
			new HashSet<>(Arrays.asList(
					...
					"has_callback", "height", "importance", "item", "item_class",
					...
					"provider_error", "pss_bytes", "rate_bucket", "reason", "remote", "request",
					"reason_code", "request_type", "result_count", "revision", "rss_bytes", "rss_kb",
					"sdk", "seed_count",
					"selected_engine_class", "selected_engine_id", "skip", "stack", "stale", "stalled_for_ms",
