...
| One Stremio addon ID | `modules/web/build.gradle` | Generated addon metadata |
...
| No native Stremio runtime | Source and dependency audit | No native Stremio module or torrent dependency |
...
| No native torrent payload | APK archive inspection | PASS: no torrent native library is packaged |
...
credentials or storage, or implement a native Stremio player or torrent transport.
