...
readiness remains **PARTIAL** until the independently recorded MediaSession/DHU, multi-audio,
next-track, and user-configured streaming-server/torrent boundaries have evidence. See
